...
<ul class="widget widget-menu unstyled">
							<li>
								...
								<ul id="togglePages" class="collapse unstyled">
									...
									{
									?>
											<b class="label orange pull-right"><?php echo htmlentities($num_rows1)-1; ?></b>
											<?php } ?>
										</a>
									</li>
									<li>
									...
									<li>
										...
										{?><b class="label green pull-right"><?php echo htmlentities($num1)-1; ?></b>
										<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="enquiry.php"><i class="menu-icon icon-comments-alt"></i>Enquiry</a></li>
                            </ul><!--/.widget-nav-->
